...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
     Counter 1 is local scope, counter 2 is global scope.

  2. Which of the two uses a closure? How can you tell?
    Counter 2 uses a closure. This is because it has a function that has a variable in it that needs to reach out of itself for its value.
